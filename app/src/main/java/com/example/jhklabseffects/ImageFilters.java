...
public class ImageFilters {
    ...
    public List<DataModelFilters> setupFilterThumbs(Bitmap bitmap){
        List<DataModelFilters> thumbs = new ArrayList<>();
        thumbs.add(new DataModelFilters(applyBlackFilter(bitmap),"Black"));
        thumbs.add(new DataModelFilters(applyBrightnessEffect(bitmap,80),"Bright"));
        thumbs.add(new DataModelFilters(applyDecreaseColorDepthEffect(bitmap,32),"Depth 32"));
        thumbs.add(new DataModelFilters(applyDecreaseColorDepthEffect(bitmap,64),"Depth 64"));
        thumbs.add(new DataModelFilters(applyContrastEffect(bitmap,70),"Contrast"));
        thumbs.add(new DataModelFilters(applyFleaEffect(bitmap),"Flea"));
        thumbs.add(new DataModelFilters(applyGammaEffect(bitmap,1.8,1.8,1.8),"Gamma"));
        thumbs.add(new DataModelFilters(applyGaussianBlurEffect(bitmap),"Gassian Blur"));
        thumbs.add(new DataModelFilters(applyGreyscaleEffect(bitmap),"Gray Scale"));
        thumbs.add(new DataModelFilters(applyHueFilter(bitmap,2),"Hue"));
        thumbs.add(new DataModelFilters(applyInvertEffect(bitmap),"Invert"));
        thumbs.add(new DataModelFilters(applyMeanRemovalEffect(bitmap),"Mean"));
        thumbs.add(new DataModelFilters(applyReflection(bitmap),"Reflection"));
        thumbs.add(new DataModelFilters(applyRoundCornerEffect(bitmap,45),"Round"));
        thumbs.add(new DataModelFilters(applySaturationFilter(bitmap,5),"Saturation"));
        return thumbs;
    }

    public Bitmap setFilter(int position,Bitmap bitmap){
        switch (position){
            case 0:return applyBlackFilter(bitmap);
            case 1:return applyBrightnessEffect(bitmap,80);
            case 2:return applyDecreaseColorDepthEffect(bitmap,32);
            case 3:return applyDecreaseColorDepthEffect(bitmap,64);
            case 4:return applyContrastEffect(bitmap,70);
            case 5:return applyFleaEffect(bitmap);
            case 6:return applyGammaEffect(bitmap,1.8,1.8,1.8);
            case 7:return applyGaussianBlurEffect(bitmap);
            case 8:return applyGreyscaleEffect(bitmap);
            case 9:return applyHueFilter(bitmap,2);
            case 10:return applyInvertEffect(bitmap);
            case 11:return applyMeanRemovalEffect(bitmap);
            case 12:return applyReflection(bitmap);
            case 13:return applyRoundCornerEffect(bitmap,45);
            case 14:return applySaturationFilter(bitmap,1);
            default: return null;
        }
